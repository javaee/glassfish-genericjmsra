...
public class ExceptionUtils  {
    ...
    public static javax.resource.spi.SecurityException 
        newSecurityException(Throwable t) {
        javax.resource.spi.SecurityException se = 
        new javax.resource.spi.SecurityException(t.getMessage());
        return (javax.resource.spi.SecurityException) se.initCause(t);
    }

    public static InvalidPropertyException 
         newInvalidPropertyException(Throwable t) {
         InvalidPropertyException ipe = 
         new InvalidPropertyException(t.getMessage());
    ...
    public static ResourceAdapterInternalException 
         newResourceAdapterInternalException(Throwable t) {
         ResourceAdapterInternalException se = 
         new ResourceAdapterInternalException(t.getMessage());
