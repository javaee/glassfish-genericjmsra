...
public abstract class ObjectBuilder {
    ...
    protected Hashtable parseToProperties(String prop) 
        ...
        _logger.log(Level.FINE, "parseToProperties:" + prop + " delimited:" + delimiter + " seperator:" + separator);
        ...
        while (tokenList.hasMoreTokens()) {
            ...
            _logger.log(Level.FINEST, "PropertyValuePair : " + 
                        propValuePair + ", separator:" + separator); 
    ...
    public Object build() throws ResourceException{
        if (builtObject == null) {
           ...
           _logger.log(Level.FINEST, "Created the object based on class :" + builtObject.getClass().getName());
           if (this.setterMethodName != null && 
               ! this.setterMethodName.trim().equals("")) {
               _logger.log(Level.FINEST, 
               "About to set properties on " + builtObject + " using methodName :" + setterMethodName);
               setUsingCommonSetterMethod(builtObject, parseToProperties(propString));
           } else {
               _logger.log(Level.FINEST, 
    ...
    private void setUsingCommonSetterMethod(Object obj, Hashtable props) 
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                "Setting property " + key + ":" + value + " on " + obj.getClass().getName());
            ...
            for (int i=0; i < methods.length; i++) {
                ...
                if (name.startsWith("set")) {
                    ...
                    if (props.containsKey(propName)) {
                        ...
                        _logger.log(Level.FINER, 
                        "Setting property " + propName + ":" + propValue + " on " + obj.getClass().getName());
