	 ...
	 */
	    ...
	    if (msg != null) {
	       ...
	       System.out.println("Received more than expected number of " +
            ...
            //Ensure that all the messagse from the Sender Topic have been consumed.
/*
 
            System.out.println("Ensure that all the messagse from the Sender Topic have been consumed.");
	    TopicConnectionFactory topicConnectionFactory = 
            ...
            TopicSubscriber topicSubscriber = topicConnectionFactory.createTopicConnection().createTopicSession(false,Session.AUTO_ACKNOWLEDGE).createSubscriber(topic);
            TextMessage msg2 = (TextMessage) topicSubscriber.receive(TIME_OUT);
            
            if (msg2 != null) {
               pass = false;
               System.out.println("Received message from the sender topic " + 
                               msg.getText());
            }
*/
